      ...
      <div className='flex items-center justify-center px-10'>
        <form className='bg-white w-full max-w-[486px] space-y-8 py-10'>
          ...
          <p className='text-app-gray font-inter text-base/[26px] font-semibold'>
            Don’t have an accout yet?  <a href='/register' className='text-app-green cursor-pointer'>Sign Up</a>
          </p>
          <CustomInput
            id="name"
            type="text"
          ...
          <div className='flex justify-between items-center'>
            ...
            <a href="/forgot-password" className='text-app-black font-inter text-xs md:text-base leading-[26px] font-semibold'>
              Forgot password?
            </a>
          </div>
