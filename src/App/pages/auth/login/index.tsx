  ...
  return (
    <div className='grid md:grid-cols-2 h-screen text-app-black'>
      ...
      <div className='flex items-center justify-center px-10'>
        <form className='bg-white w-full max-w-[486px] space-y-8'>
          ...
          <p className='text-app-gray font-inter text-base/[26px] font-semibold'>
            Already have an account? <a className='text-app-green'>Sign in</a>
          </p>
          <CustomInput
            id="name"
            type="text"
          ...
          <div className="flex items-center gap-2 text-nowrap flex-wrap">
            <input
              id="accept"
              type="checkbox"
              className="w-5 h-5 text-gray-500 border-2 rounded focus:ring-0 checked:bg-app-black checked:border-[#6C7275]"
              defaultChecked
            />
